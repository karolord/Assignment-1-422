...
public class Cthread extends Thread {
    ...
    public void run() {
        ...
        for (int i = 0; i < arr.size(); i++) {
            arr.get(i).text.writeLock().lock();
            try {
                arr.get(i).c.await();
                System.out.println("a : " + arr.get(i).getArticle1() + " an : " + arr.get(i).getArticle2() + " The
: " + arr.get(i).getArticle3());
            } catch (Exception e) {
                // TODO: handle exception
            } finally {
                arr.get(i).text.writeLock().unlock();
            }
        }
    }
}
...
// t.c.await();
// System.out.println(
// name + " : " + "a : " + t.getArticle1() + " an : " + t.getArticle2() + " The
// : " + t.getArticle3());
